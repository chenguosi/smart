    ...
    function showNotice(){
        layer.open({
            ...
            content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px;' +
                ' text-indent:2em;border-bottom:1px solid #e2e2e2;"><p class="layui-red">请使用模版前请务必仔细阅读首页右下角的《更新日志》，避免使用中遇到一些简单的问题造成困扰。</p></pclass></p><p><span class="layui-red">无</span></p></div>',
