	...
	<div class="layui-layout layui-layout-admin">
		...
		<div class="layui-header header">
			<div class="layui-main mag0">
				<a href="${basePath!}/welcome" class="logo">demo</a>
				<!-- 显示/隐藏菜单 -->
		...
		<div class="layui-footer footer">
			<p><span>copyright @2018 ChinaMobile</span></p>
		</div>
	</div>
    ...
    layui.use(['bodyTab','form','element','layer','jquery'],function(){
        ...
        function lockPage(){
            layer.open({
                ...
                '<div class="admin-header-lock-name" id="lockUserName">${currentUser.userName!}</div>'+
                '<div class="input_btn">'+
